...
<div class="page-wrap">
    <ul class="nav mb15 clearfix bottom-line nav-line">
        ...
        <li class="active"><a href="<?php echo site_url('admin/article/add');?>">添加文章</a></li>
    </ul>
    ...
    <form class="form-horizontal block-form" method="post">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input name="seo_keywords" class="span10" type="text" id="seo_keywords">
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="seo_description">SEO描述文字：</label>
            <div class="controls">
                <textarea name="seo_description" class="span10" rows="3" id="seo_description"></textarea>
            </div>
        </div>
