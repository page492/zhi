...
<div class="page-wrap">
    ...
    <div class="mb10">
        <a class="btn btn-small" href="<?php echo site_url('admin/tag/add'); ?>" data-toggle="dialog" data-title="添加标签" data-id="add"><i class="icon-plus"></i> 添加标签</a>
    </div>

    <form action="<?php echo site_url('admin/tag/delete'); ?>" method="post">
    <table class="table table-hover table-list">
        ...
        <?php foreach ($list as $val): ?>
            <tr>
                ...
                <td>
                    <a class="mr5" href="<?php echo site_url('admin/tag/edit/'.$val['id']);?>" data-toggle="dialog" data-title="编辑标签" data-id="edit"><i class="icon-edit"></i>编辑</a>
                    <a href="<?php echo site_url('admin/tag/delete/'.$val['id']);?>" data-toggle="confirmurl" data-acttype="ajax" data-msg="确认要删除此标签？"><i class="icon-trash"></i>删除</a>
                </td>
            </tr>
        <?php endforeach;?>
        </tbody>
