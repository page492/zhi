...
<div class="page-wrap">
    <div class="mb10">
        <a class="btn btn-small" href="<?php echo site_url('admin/category/add');?>" data-toggle="dialog" data-title="添加分类" data-id="add"><i class="icon-plus"></i> 添加分类</a>
    </div>
    <form action="<?php echo site_url('admin/category/delete'); ?>" method="post">
