...
<div class="page-wrap">
    ...
    <ul class="nav mb15 clearfix bottom-line nav-line">
        <li class="active"><a href="<?php echo site_url('admin/advert'); ?>">广告列表</a></li>
        <li><a href="<?php echo site_url('admin/advert_pt'); ?>">广告位置</a></li>
    </ul>

    <div class="mb10">
        <a class="btn btn-small" href="<?php echo site_url('admin/advert/add/'); ?>" data-toggle="dialog" data-title="添加广告" data-id="add"><i class="icon-plus"></i> 添加广告</a>
    </div>

    <form action="<?php echo site_url('admin/advert/delete'); ?>" method="post">
    <table class="table table-hover table-list">
        ...
        <?php foreach ($list as $val): ?>
            <tr>
                ...
                <td><?php echo $pt_list[$val['pt_id']];?></td>
                <td><?php echo $val['orderid'];?></td>
                <td>
                    <a class="mr5" href="<?php echo site_url('admin/advert/edit/'.$val['id']);?>" data-toggle="dialog" data-title="编辑链接" data-id="edit"><i class="icon-edit"></i>编辑</a>
                    <a href="<?php echo site_url('admin/advert/delete/'.$val['id']);?>" data-toggle="confirmurl" data-acttype="ajax" data-msg="确认要删除？"><i class="icon-trash"></i>删除</a>
                </td>
            </tr>
        <?php endforeach;?>
        </tbody>
